<?php
// FILE: actions/save-archetype.php
session_start();
...
if ($id) {
    ...
    $_SESSION['flash'] = ['type' => 'success', 'msg' => 'Archetype updated successfully.'];
} else {
    ...
    $_SESSION['flash'] = ['type' => 'success', 'msg' => 'New Space Archetype published.'];
}
