    ...
    <div class="max-w-6xl mx-auto">
        ...
        <header class="flex justify-between items-end mb-12 form-reveal">
            <div>
                ...
                <h1 class="text-4xl font-serif font-light italic">Property <span class="text-muted">Categories</span></h1>
            </div>
            <a href="<?= BASE ?>admin/add-archetype.php" 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 form-reveal" style="animation-delay: 0.1s">
            <?php if (empty($archetypes)): ?>
                <div class="col-span-full py-20 text-center bg-background rounded-[2.5rem] border border-sand/40">
                    <p class="text-serif italic text-muted text-xl">No categories added yet.</p>
                </div>
            <?php endif; ?>
            ...
            <div class="bg-background rounded-[2.5rem] border border-sand/40 overflow-hidden shadow-sm group">
                ...
                <div class="p-8">
                    ...
                    <div class="flex items-center justify-between pt-6 border-t border-sand/30">
                        <a href="<?= BASE ?>admin/add-archetype.php?id=<?= $a['id'] ?>" class="text-[10px] font-bold uppercase tracking-widest text-accent hover:text-accent-dark transition-colors">Edit</a>
                        <form method="POST" action="<?= BASE ?>actions/delete-archetype.php" onsubmit="return confirm('Remove this archetype from the gallery?');">
