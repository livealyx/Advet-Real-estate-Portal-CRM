...
<main class="flex-grow p-8 sm:p-12 overflow-y-auto">
    <div class="max-w-3xl mx-auto">
        ...
        <header class="mb-12 form-reveal">
            <a href="<?= BASE ?>admin/archetypes.php" class="text-[10px] font-bold uppercase tracking-widest text-accent hover:text-accent-dark flex items-center gap-2 mb-6">
        ...
        <form method="POST" action="<?= BASE ?>actions/save-archetype.php" enctype="multipart/form-data" class="bg-background p-12 rounded-[2.5rem] shadow-sm border border-sand/40 space-y-8 form-reveal" style="animation-delay: 0.1s">
            <?php if ($id): ?>
